/* Lava IG 操控室 — 四頁籤介面。共用層見 core.js。 */
(() => {
"use strict";
const { C, LS, S, MODE, isLocalHost, $, el, esc, nfmt, strToB64, apiBase, rawUrl, authHdr, apiGet, shaOf, saveJson, setImg, img, STATE, FILES, loadAll, toast, modal, nowISO, rid } = window.LavaCore;
